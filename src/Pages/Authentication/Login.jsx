...
const Login = () => {
    ...
    return (
        <div>
            <section className="bg-emerald-50 dark:bg-gray-800">
                <div className="container flex items-center justify-center min-h-screen mx-auto">
                    <form onSubmit={handleLogin} className="w-full rounded bg-emerald-100 dark:bg-gray-700 p-5 max-w-md ">
                        <p className="text-center text-xl dark:text-white">Welcome Back to QueryNest!</p>
                        ...
                        <div className="mt-6">
                            ...
                            <button onClick={handleGoogleLogIn} className="flex items-center dark:bg-gray-600 justify-center  w-full px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-500">
                            ...
                            <button onClick={handleGithubLogIn} className="flex w-full items-center justify-center   px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border dark:bg-gray-600 rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-500">

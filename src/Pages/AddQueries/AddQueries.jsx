...
const AddQueries = () => {
    ...
    return (
        <div className="dark:bg-gray-800 py-7">
            <div className="max-w-4xl mx-auto">
                <form onSubmit={handleAddQueries} className="card-body bg-emerald-100 dark:bg-gray-700  rounded">
                    <h1 className="text-2xl font-bold text-center text-emerald-800 dark:text-white py-5">Add Your Queries</h1>
